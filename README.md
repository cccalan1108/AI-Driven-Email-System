...
- CTCI internal security drill documentation

---

## 10. License and Disclaimer | 授權與聲明

**English:**  
This project is for internal security awareness training only. Do not use for unauthorized real phishing attacks.

**中文：**  
本專案為企業內部資安演練用途。請勿用於非授權之真實釣魚攻擊。
